    ...
    constructor() {
        this.languages = {
            '中文': {
                ...
                'btn_wechat_pay': '微信(F)',
                'btn_settle': '结算(Space)',
                'btn_cash_drawer': '钱箱(G)',
                'btn_reprint_last': '重打上单(D)',
                'btn_member_card': '会员卡(H)',
                'pay_action_cash': '现金',
            ...
            'English': {
                ...
                'payment_prefix': 'Pay: ',
                'currency_symbol': '',
                'btn_cancel_order': 'Cancel Order (A)',
                'btn_hold_order': 'Hold (B)',
                'btn_pick_order': 'Pickup (B)',
                'btn_cash_pay': 'Cash (C)',
                'btn_alipay': 'Alipay (E)',
                'btn_wechat_pay': 'WeChat (F)',
                'btn_settle': 'Settle (Space)',
                'btn_cash_drawer': 'Cash Drawer (G)',
                'btn_reprint_last': 'Reprint Last (D)',
                'btn_member_card': 'Member Card (H)',
